...
show = Button(root, text='Show', font=('verdana', '10', 'bold'),
              relief=RIDGE, borderwidth=2, bg='skyblue', command=show)
show.place(x=140, y=250)

clear = Button(root, text='Clear', font=('verdana', '10', 'bold'),
               relief=RIDGE, borderwidth=2, bg='lime', command=clear)
clear.place(x=200, y=250)

exit = Button(root, text='Exit', font=('verdana', '10', 'bold'),
              relief=RIDGE, borderwidth=2, bg='red', command=root.destroy)
